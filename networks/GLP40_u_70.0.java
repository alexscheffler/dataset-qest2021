...
public class GLP40_u_70.0 implements ServerGraphFactory {
	...
	public void createServers1( ServerGraph sg, Server[] servers ) throws Exception {
		servers[54] = sg.addServer( "s75", factory.createServiceCurve( "SC{(0.0,0.0),50.0}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[33] = sg.addServer( "s81", factory.createServiceCurve( "SC{(0.0,0.0),57.142857142857146}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[4] = sg.addServer( "s29", factory.createServiceCurve( "SC{(0.0,0.0),14.285714285714286}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[46] = sg.addServer( "s45", factory.createServiceCurve( "SC{(0.0,0.0),35.714285714285715}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[8] = sg.addServer( "s36", factory.createServiceCurve( "SC{(0.0,0.0),192.85714285714286}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[3] = sg.addServer( "s88", factory.createServiceCurve( "SC{(0.0,0.0),78.57142857142857}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[81] = sg.addServer( "s6", factory.createServiceCurve( "SC{(0.0,0.0),64.28571428571429}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[24] = sg.addServer( "s30", factory.createServiceCurve( "SC{(0.0,0.0),85.71428571428572}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[87] = sg.addServer( "s113", factory.createServiceCurve( "SC{(0.0,0.0),71.42857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[30] = sg.addServer( "s67", factory.createServiceCurve( "SC{(0.0,0.0),85.71428571428572}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[45] = sg.addServer( "s83", factory.createServiceCurve( "SC{(0.0,0.0),92.85714285714286}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[99] = sg.addServer( "s28", factory.createServiceCurve( "SC{(0.0,0.0),121.42857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		...
		servers[66] = sg.addServer( "s26", factory.createServiceCurve( "SC{(0.0,0.0),121.42857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[80] = sg.addServer( "s74", factory.createServiceCurve( "SC{(0.0,0.0),71.42857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		...
		servers[10] = sg.addServer( "s17", factory.createServiceCurve( "SC{(0.0,0.0),42.85714285714286}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[14] = sg.addServer( "s9", factory.createServiceCurve( "SC{(0.0,0.0),64.28571428571429}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[112] = sg.addServer( "s115", factory.createServiceCurve( "SC{(0.0,0.0),142.85714285714286}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[89] = sg.addServer( "s116", factory.createServiceCurve( "SC{(0.0,0.0),142.85714285714286}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[96] = sg.addServer( "s31", factory.createServiceCurve( "SC{(0.0,0.0),78.57142857142857}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[70] = sg.addServer( "s84", factory.createServiceCurve( "SC{(0.0,0.0),85.71428571428572}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[88] = sg.addServer( "s79", factory.createServiceCurve( "SC{(0.0,0.0),7.142857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[12] = sg.addServer( "s111", factory.createServiceCurve( "SC{(0.0,0.0),235.71428571428572}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[95] = sg.addServer( "s12", factory.createServiceCurve( "SC{(0.0,0.0),71.42857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[82] = sg.addServer( "s69", factory.createServiceCurve( "SC{(0.0,0.0),121.42857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[1] = sg.addServer( "s44", factory.createServiceCurve( "SC{(0.0,0.0),71.42857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[22] = sg.addServer( "s2", factory.createServiceCurve( "SC{(0.0,0.0),400.0}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[79] = sg.addServer( "s87", factory.createServiceCurve( "SC{(0.0,0.0),21.42857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[53] = sg.addServer( "s85", factory.createServiceCurve( "SC{(0.0,0.0),71.42857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		...
		servers[40] = sg.addServer( "s97", factory.createServiceCurve( "SC{(0.0,0.0),64.28571428571429}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[103] = sg.addServer( "s32", factory.createServiceCurve( "SC{(0.0,0.0),114.28571428571429}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[50] = sg.addServer( "s95", factory.createServiceCurve( "SC{(0.0,0.0),28.571428571428573}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[43] = sg.addServer( "s56", factory.createServiceCurve( "SC{(0.0,0.0),71.42857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[5] = sg.addServer( "s66", factory.createServiceCurve( "SC{(0.0,0.0),71.42857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[32] = sg.addServer( "s16", factory.createServiceCurve( "SC{(0.0,0.0),28.571428571428573}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[25] = sg.addServer( "s89", factory.createServiceCurve( "SC{(0.0,0.0),235.71428571428572}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[27] = sg.addServer( "s112", factory.createServiceCurve( "SC{(0.0,0.0),78.57142857142857}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		...
		servers[48] = sg.addServer( "s62", factory.createServiceCurve( "SC{(0.0,0.0),28.571428571428573}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[97] = sg.addServer( "s86", factory.createServiceCurve( "SC{(0.0,0.0),57.142857142857146}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[84] = sg.addServer( "s72", factory.createServiceCurve( "SC{(0.0,0.0),100.0}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[38] = sg.addServer( "s10", factory.createServiceCurve( "SC{(0.0,0.0),7.142857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		...
		servers[115] = sg.addServer( "s99", factory.createServiceCurve( "SC{(0.0,0.0),35.714285714285715}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[29] = sg.addServer( "s15", factory.createServiceCurve( "SC{(0.0,0.0),50.0}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[75] = sg.addServer( "s102", factory.createServiceCurve( "SC{(0.0,0.0),35.714285714285715}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[78] = sg.addServer( "s80", factory.createServiceCurve( "SC{(0.0,0.0),171.42857142857144}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[71] = sg.addServer( "s13", factory.createServiceCurve( "SC{(0.0,0.0),42.85714285714286}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[102] = sg.addServer( "s8", factory.createServiceCurve( "SC{(0.0,0.0),221.42857142857144}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[23] = sg.addServer( "s1", factory.createServiceCurve( "SC{(0.0,0.0),85.71428571428572}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		...
		servers[35] = sg.addServer( "s100", factory.createServiceCurve( "SC{(0.0,0.0),28.571428571428573}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[109] = sg.addServer( "s42", factory.createServiceCurve( "SC{(0.0,0.0),92.85714285714286}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[34] = sg.addServer( "s71", factory.createServiceCurve( "SC{(0.0,0.0),142.85714285714286}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[42] = sg.addServer( "s19", factory.createServiceCurve( "SC{(0.0,0.0),64.28571428571429}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[117] = sg.addServer( "s64", factory.createServiceCurve( "SC{(0.0,0.0),35.714285714285715}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[18] = sg.addServer( "s65", factory.createServiceCurve( "SC{(0.0,0.0),171.42857142857144}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		...
		servers[92] = sg.addServer( "s48", factory.createServiceCurve( "SC{(0.0,0.0),114.28571428571429}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		...
		servers[60] = sg.addServer( "s18", factory.createServiceCurve( "SC{(0.0,0.0),64.28571428571429}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[0] = sg.addServer( "s41", factory.createServiceCurve( "SC{(0.0,0.0),550.0}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[13] = sg.addServer( "s5", factory.createServiceCurve( "SC{(0.0,0.0),42.85714285714286}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[63] = sg.addServer( "s60", factory.createServiceCurve( "SC{(0.0,0.0),28.571428571428573}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[86] = sg.addServer( "s104", factory.createServiceCurve( "SC{(0.0,0.0),50.0}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[64] = sg.addServer( "s33", factory.createServiceCurve( "SC{(0.0,0.0),7.142857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[21] = sg.addServer( "s91", factory.createServiceCurve( "SC{(0.0,0.0),200.0}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[16] = sg.addServer( "s105", factory.createServiceCurve( "SC{(0.0,0.0),78.57142857142857}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[47] = sg.addServer( "s77", factory.createServiceCurve( "SC{(0.0,0.0),128.57142857142858}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[52] = sg.addServer( "s108", factory.createServiceCurve( "SC{(0.0,0.0),64.28571428571429}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[113] = sg.addServer( "s43", factory.createServiceCurve( "SC{(0.0,0.0),50.0}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		...
		servers[41] = sg.addServer( "s109", factory.createServiceCurve( "SC{(0.0,0.0),85.71428571428572}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[62] = sg.addServer( "s61", factory.createServiceCurve( "SC{(0.0,0.0),64.28571428571429}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[101] = sg.addServer( "s14", factory.createServiceCurve( "SC{(0.0,0.0),350.0}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[17] = sg.addServer( "s35", factory.createServiceCurve( "SC{(0.0,0.0),114.28571428571429}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[49] = sg.addServer( "s37", factory.createServiceCurve( "SC{(0.0,0.0),107.14285714285715}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[73] = sg.addServer( "s51", factory.createServiceCurve( "SC{(0.0,0.0),128.57142857142858}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[59] = sg.addServer( "s94", factory.createServiceCurve( "SC{(0.0,0.0),92.85714285714286}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[56] = sg.addServer( "s117", factory.createServiceCurve( "SC{(0.0,0.0),64.28571428571429}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		...
		servers[76] = sg.addServer( "s110", factory.createServiceCurve( "SC{(0.0,0.0),92.85714285714286}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		...
		servers[104] = sg.addServer( "s3", factory.createServiceCurve( "SC{(0.0,0.0),64.28571428571429}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[72] = sg.addServer( "s103", factory.createServiceCurve( "SC{(0.0,0.0),57.142857142857146}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[105] = sg.addServer( "s96", factory.createServiceCurve( "SC{(0.0,0.0),64.28571428571429}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[31] = sg.addServer( "s93", factory.createServiceCurve( "SC{(0.0,0.0),85.71428571428572}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[68] = sg.addServer( "s11", factory.createServiceCurve( "SC{(0.0,0.0),92.85714285714286}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[37] = sg.addServer( "s101", factory.createServiceCurve( "SC{(0.0,0.0),57.142857142857146}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[98] = sg.addServer( "s21", factory.createServiceCurve( "SC{(0.0,0.0),92.85714285714286}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[15] = sg.addServer( "s53", factory.createServiceCurve( "SC{(0.0,0.0),164.2857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[44] = sg.addServer( "s58", factory.createServiceCurve( "SC{(0.0,0.0),150.0}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[91] = sg.addServer( "s92", factory.createServiceCurve( "SC{(0.0,0.0),50.0}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		...
		servers[9] = sg.addServer( "s57", factory.createServiceCurve( "SC{(0.0,0.0),150.0}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[51] = sg.addServer( "s63", factory.createServiceCurve( "SC{(0.0,0.0),57.142857142857146}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[110] = sg.addServer( "s46", factory.createServiceCurve( "SC{(0.0,0.0),335.7142857142857}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[85] = sg.addServer( "s25", factory.createServiceCurve( "SC{(0.0,0.0),100.0}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[11] = sg.addServer( "s34", factory.createServiceCurve( "SC{(0.0,0.0),150.0}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[74] = sg.addServer( "s52", factory.createServiceCurve( "SC{(0.0,0.0),21.42857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[111] = sg.addServer( "s22", factory.createServiceCurve( "SC{(0.0,0.0),28.571428571428573}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[2] = sg.addServer( "s24", factory.createServiceCurve( "SC{(0.0,0.0),64.28571428571429}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[67] = sg.addServer( "s114", factory.createServiceCurve( "SC{(0.0,0.0),7.142857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[65] = sg.addServer( "s76", factory.createServiceCurve( "SC{(0.0,0.0),135.71428571428572}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[7] = sg.addServer( "s20", factory.createServiceCurve( "SC{(0.0,0.0),107.14285714285715}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		...
		servers[100] = sg.addServer( "s98", factory.createServiceCurve( "SC{(0.0,0.0),50.0}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[114] = sg.addServer( "s54", factory.createServiceCurve( "SC{(0.0,0.0),214.2857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[94] = sg.addServer( "s73", factory.createServiceCurve( "SC{(0.0,0.0),21.42857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[26] = sg.addServer( "s47", factory.createServiceCurve( "SC{(0.0,0.0),192.85714285714286}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[106] = sg.addServer( "s4", factory.createServiceCurve( "SC{(0.0,0.0),50.0}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[19] = sg.addServer( "s106", factory.createServiceCurve( "SC{(0.0,0.0),57.142857142857146}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[57] = sg.addServer( "s27", factory.createServiceCurve( "SC{(0.0,0.0),7.142857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[39] = sg.addServer( "s107", factory.createServiceCurve( "SC{(0.0,0.0),71.42857142857143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
	}
