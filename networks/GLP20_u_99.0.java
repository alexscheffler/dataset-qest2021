...
public class GLP20_u_99.0 implements ServerGraphFactory {
	...
	public void createServers1( ServerGraph sg, Server[] servers ) throws Exception {
		servers[10] = sg.addServer( "s19", factory.createServiceCurve( "SC{(0.0,0.0),191.91919191919192}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[32] = sg.addServer( "s14", factory.createServiceCurve( "SC{(0.0,0.0),80.8080808080808}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[0] = sg.addServer( "s34", factory.createServiceCurve( "SC{(0.0,0.0),141.41414141414143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[35] = sg.addServer( "s22", factory.createServiceCurve( "SC{(0.0,0.0),90.9090909090909}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[6] = sg.addServer( "s28", factory.createServiceCurve( "SC{(0.0,0.0),60.60606060606061}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		...
		servers[3] = sg.addServer( "s31", factory.createServiceCurve( "SC{(0.0,0.0),136.36363636363637}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[1] = sg.addServer( "s11", factory.createServiceCurve( "SC{(0.0,0.0),50.505050505050505}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[30] = sg.addServer( "s24", factory.createServiceCurve( "SC{(0.0,0.0),171.7171717171717}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[31] = sg.addServer( "s33", factory.createServiceCurve( "SC{(0.0,0.0),30.303030303030305}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[37] = sg.addServer( "s1", factory.createServiceCurve( "SC{(0.0,0.0),111.11111111111111}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[5] = sg.addServer( "s18", factory.createServiceCurve( "SC{(0.0,0.0),50.505050505050505}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[25] = sg.addServer( "s3", factory.createServiceCurve( "SC{(0.0,0.0),176.76767676767676}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[8] = sg.addServer( "s37", factory.createServiceCurve( "SC{(0.0,0.0),50.505050505050505}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[24] = sg.addServer( "s21", factory.createServiceCurve( "SC{(0.0,0.0),121.21212121212122}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[26] = sg.addServer( "s36", factory.createServiceCurve( "SC{(0.0,0.0),141.41414141414143}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[18] = sg.addServer( "s0", factory.createServiceCurve( "SC{(0.0,0.0),101.01010101010101}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[34] = sg.addServer( "s5", factory.createServiceCurve( "SC{(0.0,0.0),55.55555555555556}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[2] = sg.addServer( "s29", factory.createServiceCurve( "SC{(0.0,0.0),85.85858585858585}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[4] = sg.addServer( "s30", factory.createServiceCurve( "SC{(0.0,0.0),30.303030303030305}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[11] = sg.addServer( "s32", factory.createServiceCurve( "SC{(0.0,0.0),196.96969696969697}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[22] = sg.addServer( "s8", factory.createServiceCurve( "SC{(0.0,0.0),116.16161616161617}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[29] = sg.addServer( "s26", factory.createServiceCurve( "SC{(0.0,0.0),30.303030303030305}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[27] = sg.addServer( "s12", factory.createServiceCurve( "SC{(0.0,0.0),65.65656565656566}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[17] = sg.addServer( "s17", factory.createServiceCurve( "SC{(0.0,0.0),40.4040404040404}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[19] = sg.addServer( "s13", factory.createServiceCurve( "SC{(0.0,0.0),70.70707070707071}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[21] = sg.addServer( "s4", factory.createServiceCurve( "SC{(0.0,0.0),242.42424242424244}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		...
		servers[13] = sg.addServer( "s9", factory.createServiceCurve( "SC{(0.0,0.0),156.56565656565655}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[20] = sg.addServer( "s7", factory.createServiceCurve( "SC{(0.0,0.0),262.62626262626264}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[16] = sg.addServer( "s25", factory.createServiceCurve( "SC{(0.0,0.0),65.65656565656566}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[7] = sg.addServer( "s2", factory.createServiceCurve( "SC{(0.0,0.0),15.151515151515152}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[15] = sg.addServer( "s10", factory.createServiceCurve( "SC{(0.0,0.0),30.303030303030305}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[9] = sg.addServer( "s16", factory.createServiceCurve( "SC{(0.0,0.0),25.252525252525253}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		...
		servers[23] = sg.addServer( "s27", factory.createServiceCurve( "SC{(0.0,0.0),50.505050505050505}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
		servers[12] = sg.addServer( "s15", factory.createServiceCurve( "SC{(0.0,0.0),85.85858585858585}" ), factory.createMaxServiceCurve( "MSC{(0.0,0.0),0.0;!(0.0,Infinity),0.0}" ), Multiplexing.ARBITRARY, true, true );
	}
